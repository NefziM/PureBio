				...
				$fname = $_FILES['file']['name'];
					...
					{        
									if($fsize>=1000000)
										...
										{
												$sql = "update produit set rs_id='$_POST[res_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";
												mysqli_query($db, $sql); 
                                    ...
                                    <div class="card card-outline-primary">
                                        ...
                                        <div class="card-body">
                                            <form action='' method='post' enctype="multipart/form-data">
                                                <div class="form-body">
                                                    <?php $qml ="select * from produit where d_id='$_GET[menu_upd]'";
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="res_name" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                                    ...
                                                                    <?php $ssql ="select * from fournisseur";
