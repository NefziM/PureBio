...
<header id="header" class="header-scroll top-header headrom" style="background-color:#808080;">
    ...
    <div id="logo">
      <h1><a href="index.php" style="margin-left:-5px;">PB</a></h1>
    </div>
    <div class="sub-headder position-relative">
      <h6><a href="index.html" style="margin-top:15px;">Pure<br>Bio</a></h6>
    </div>
...
$stmt = $db->prepare("SELECT * FROM produit WHERE rs_id = ? AND title LIKE ?");
$stmt->bind_param("ss", $_GET['res_id'], $searchTerm);
$stmt->execute();
                ...
                <div class="col-xs-12 col-sm-12 col-lg-8">
                    <form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=add&id=<?php echo $product['d_id']; ?>'>
                        ...
                        <div class="rest-descr">
                            ...
                            <?php
                            if ($four->num_rows > 0) {
                                while ($fournisseur = $four->fetch_assoc()) {
