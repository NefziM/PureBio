                    ...
                    <ul id="sidebarnav">
                        ...
                        <div class="page-wrapper">
                            <div style="padding-top: 10px;">
                                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> </marquee></div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white">Liste Fournisseurs</h4>
                                                </div>
                                                ...
                                                <div class="table-responsive m-t-40">
                                                    <table id="myTable" class="table table-bordered table-striped table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
												$sql="SELECT * FROM fournisseur where acc=0 order by rs_id desc  ";
												$query=mysqli_query($db,$sql);
												
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="7"><center>Aucun Fournisseur !</center></td>';
														}
													else
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['title'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 <td>
                                                                                                     <a href="accept_fournisseurs.php?fournisseur_acc='.$rows['rs_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>

                                                                                                     <a href="delete_fournisseurs.php?fournisseur_del='.$rows['rs_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									</td></tr>';
																		}	
														}
											?>
