					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO fournisseur(c_id,title,email,phone,address,image) VALUE('".$_POST['c_name']."','".$res_name."','".$_POST['email']."','".$_POST['phone']."','".$_POST['address']."','".$fnew."')";  
												mysqli_query($db, $sql); 
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-outline-primary">
                                        ...
                                        <div class="card-body">
                                            <form action='' method='post' enctype="multipart/form-data">
                                                <div class="form-body">
                                                    ...
                                                    <h3 class="box-title m-t-40"> Addresse</h3>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-md-12 ">
                                                            <div class="form-group">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="add_restaurant.php" class="btn btn-inverse">Effacer</a>
                                        </div>
                                        </form>
                                    </div>
                                </div>
