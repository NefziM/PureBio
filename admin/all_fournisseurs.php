                                                ...
                                                <div class="table-responsive m-t-40">
                                                    <table id="myTable" class="table table-bordered table-striped table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
												$sql="SELECT * FROM fournisseur where acc=1 order by rs_id desc";
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['title'].'</td>
																								...
																								<td>'.$rows['image'].'</td>																							
																								<td>'.$rows['date'].'</td>
																									 <td><a href="delete_fournisseurs.php?fournisseur_del='.$rows['rs_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									</td></tr>';
																		}	
														}
											?>
